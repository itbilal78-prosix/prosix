...
@section('content')
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('navigations.create') }}" class="btn btn-dark d-flex align-items-center gap-1">
            ...
            @forelse($navigations as $nav)
                <div class="col-md-4 mb-4">
                    <div class="card border-dark shadow-sm h-100">
                        ...
                        {{-- Card Header --}}
                        <div
                            class="card-header bg-white border-bottom border-dark
                        ...
                        <div class="card-body text-dark">
                            ...
                            <p class="mb-1">
                                <strong>Clickable:</strong> {{ $nav->clickable ? 'Yes' : 'No' }}
                            </p>
                            <p class="mb-0">
                        ...
                        <div class="card-footer bg-white border-top-0 p-2">
                            <div class="d-flex justify-content-between gap-2">
                                ...
                                {{-- Delete --}}
                                <form action="{{ route('navigations.destroy', $nav->id) }}" method="POST" class="w-50">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
