            ...
            <div class="card-body">
                ...
                <form action="{{ route('navigations.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control border-dark" placeholder="Home" required>
                    </div>

                    {{-- Slug --}}
                    <div class="mb-3">
                        <label class="form-label fw-semibold text-dark">Slug</label>
                        <input type="text" name="slug" class="form-control border-dark" placeholder="home" required>
                    </div>

                    {{-- Route --}}
                    <div class="mb-3">
                        <label class="form-label fw-semibold text-dark">Route</label>
                        <input type="text" name="route" class="form-control border-dark" placeholder="/home">
                    </div>

                    {{-- Position --}}
                    <div class="mb-3">
                        <label class="form-label fw-semibold text-dark">Position</label>
                        <input type="number" name="position" class="form-control border-dark" value="0">
                    </div>
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input border-dark" type="checkbox" name="clickable" id="clickable" checked>
                        <label class="form-check-label text-dark fw-semibold" for="clickable">
                            Click opens page
                        </label>
                    </div>
                    {{-- Status --}}
                    <div class="form-check mb-4">
                        <input class="form-check-input border-dark" type="checkbox" name="status" id="status" checked>
