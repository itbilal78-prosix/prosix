...
@section('content')
    <div class="container mt-4">
        ...
        <h2 class="fw-bold mb-3 text-dark">Edit Navigation</h2>
        ...
        <div class="card shadow-sm border border-dark">
            <div class="card-body">
                <form action="{{ route('navigations.update', $navigation->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="slug" class="form-control border-dark"
                            value="{{ $navigation->slug }}" required>
                    </div>

                    {{-- Route --}}
                    <div class="mb-3">
                        <label class="form-label fw-semibold text-dark">Route</label>
                        <input type="text" name="route" class="form-control border-dark"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="position" class="form-control border-dark"
                            value="{{ $navigation->position }}">
                    </div>

                    {{-- Has Dropdown --}}
                    <div class="form-check mb-3">
                        <input class="form-check-input border-dark" type="checkbox" name="has_dropdown" id="hasDropdown"
                            {{ $navigation->has_dropdown ? 'checked' : '' }}>
                        <label class="form-check-label fw-semibold text-dark" for="hasDropdown">
                            Has Dropdown
                        </label>
                    </div>

                    <div class="form-check mb-3">
                        <input class="form-check-input border-dark" type="checkbox" name="clickable" id="clickable"
                            {{ $navigation->clickable ? 'checked' : '' }}>

                        <label class="form-check-label fw-semibold text-dark" for="clickable">
                            Click Opens Page
                        </label>
                    </div>
                    ...
                    <div class="form-check mb-4">
                        <input class="form-check-input border-dark" type="checkbox" name="status" id="status"
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('navigations.index') }}" class="btn btn-outline-dark px-4">
                            Cancel
                        </a>
                    </div>
