    ...
    <div class="od-wrap">
        ...
        <div class="od-header">
            ...
            <form action="{{ route('admin.orders.updateStatus', $order->id) }}" method="POST" style="margin-bottom:20px;">
                ...
                <select name="status" onchange="this.form.submit()" style="padding:6px 12px;border-radius:6px;">
                            ...
                            <div class="od-item-row">
                                ...
                                @else
                                    <div class="od-item-img-placeholder">
                                        <svg width="24" height="24" fill="none" stroke="#ccc" stroke-width="1.5"
                                            viewBox="0 0 24 24">
    ...
    ">
            ...
            <div class="od-sidebar">
                    ...
                    <div class="od-customer-body">
                        ...
                        <div class="od-cust-field">
                            <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                                <path
                                    d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 10.8 19.79 19.79 0 01.0 2.18 2 2 0 012 0h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 14z" />
                            </svg>
                            <div>
                ...
                <div class="od-card mt-3">
                    ...
                    <div class="od-card-head">
                        <p class="od-card-title">Admin Notes</p>
                    </div>
                    ...
                    <div style="padding:20px;">
                        ...
                        <form method="POST" action="{{ route('admin.orders.updateNotes', $order->id) }}">
                            ...
                            <textarea name="admin_notes" class="form-control" rows="4">{{ $order->admin_notes }}</textarea>
                ...
                <div class="od-card mt-3">
                    ...
                    <div class="od-card-head">
                        <p class="od-card-title">Shipping Update</p>
                    </div>

                    <div style="padding:20px;">

                        <form method="POST" action="{{ route('admin.orders.updateShipping', $order->id) }}">
                            ...
                            <input type="date" name="dispatch_date" value="{{ $order->dispatch_date }}"
                                class="form-control mb-2">
