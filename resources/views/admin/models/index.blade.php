...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <script>const allCategories = @json($categories->load('subcategories'));</script>
        ...
        @foreach ($categories as $cat)
            <div class="cat-block" id="block-cat-{{ $cat->id }}" style="display:none;">
                ...
                <div class="block-toolbar mb-3" data-block="block-cat-{{ $cat->id }}">
                    <div class="d-flex align-items-center gap-2">
                        <input type="checkbox" class="block-select-all"
                               id="sa-block-cat-{{ $cat->id }}"
...
<div class="col-md-2 mb-4 model-col-item"
    ...
    <style>
        ...
        .cat-card {
            flex:0 0 130px; background:#fff; border:2px solid #e0e0e0;
        ...
        .sub-tab {
            background:#fff; border:1.5px solid #ccc; border-radius:20px;
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        window.switchModelSubTab = function (btn, catId, subId) {
            ...
            document.querySelectorAll(`.model-group-divider[data-cat="${catId}"],.model-group-row[data-cat="${catId}"]`)
                .forEach(el => {
        ...
        function renderToolbar(blockId) {
            ...
            if (!noneFeat) {
                ...
                b.addEventListener('click', () => doAction('{{ route("models.featured") }}', 'remove', blockId));
                toolbar.appendChild(b);
            }
       ...
       // ─── POST action (featured / apparel) ───
        ...
        setTimeout(() => {
            ...
            if (a) { a.classList.remove('show'); setTimeout(() => a.remove(), 500); }
        }, 2000);
    });
    </script>
