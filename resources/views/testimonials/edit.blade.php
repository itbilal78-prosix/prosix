...
<div class="container-fluid">
    ...
    <h2 class="text-black mb-4">Edit Testimonial</h2>
    ...
    <form action="{{ route('testimonials.update', $testimonial->id) }}" method="POST" enctype="multipart/form-data" class="p-4 border rounded shadow-sm bg-white">
        @csrf
        @method('PUT')
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="name" class="form-control border-dark" value="{{ old('name',$testimonial->name) }}" required>
            </div>

            <div class="col-md-6 mb-3">
                <label class="form-label fw-semibold text-black">Position <span class="text-danger">*</span></label>
                <input type="text" name="position" class="form-control border-dark" value="{{ old('position',$testimonial->position) }}" required>
            </div>

            <div class="col-md-6 mb-3">
                <label class="form-label fw-semibold text-black">Rating (1-5) <span class="text-danger">*</span></label>
                <input type="number" name="rating" min="1" max="5" class="form-control border-dark" value="{{ old('rating',$testimonial->rating) }}" required>
            </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <div class="mt-2">
                    <img id="imagePreview" src="{{ $testimonial->image ? asset('storage/'.$testimonial->image) : '' }}" style="{{ $testimonial->image ? '' : 'display:none;' }}" width="150" class="border rounded">
                </div>
            ...
            <div class="col-12 mb-3">
                ...
                <textarea name="text" rows="5" class="form-control border-dark" required>{{ old('text',$testimonial->text) }}</textarea>
            </div>
        </div>

        <div class="d-flex gap-2">
            <button type="submit" class="btn btn-dark px-4 py-2"> Update Testimonial</button>
...
<style scoped>
.form-control.border-dark { border:1px solid #000; color:#000; }
