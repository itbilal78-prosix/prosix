...
<div class="container mt-4">
    ...
    <form action="{{ route('deals.store') }}" method="POST" enctype="multipart/form-data" class="p-4 border rounded shadow-sm bg-white">
        @csrf
        ...
        <div class="mb-3">
            ...
            <input type="file" name="images[]" multiple class="form-control border-dark" accept="image/*" id="dealImagesInput">
