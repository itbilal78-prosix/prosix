      ...
      <div class="how-to-sidebar">
        ...
        <div class="hts-step" :class="stepClass(1)">
          ...
          <div>
            ...
            <div class="hts-desc">Fill name, email & delivery date</div>
          </div>
        </div>
...
<div class="po-color-item" @click="openCustomColor">
  <div class="po-color-swatch" style="background:#fff; border:2px dashed #000;">
    +
  </div>
...
tempCustomColor: "#000000",
  ...
  this.form.selectedColors.push(customColor);
...
addCustomColor(e) {
  ...
  this.form.selectedColors.push(customColor);
    ...
    resetForm() {
      ...
      this.form = { fullName: '', email: '', deliveryDate: '', salesRep: '', selectedColors: [], notes: '' };
...
/* ─── Layout: sidebar + form side by side ───────────── */
.po-layout {
  display: flex;
  gap: 0;
...
@media (max-width: 1200px) {
  .po-top-row { grid-template-columns: repeat(4,1fr); }
  .po-mid-row { grid-template-columns: 1fr 1fr; }
}
@media (max-width: 900px) {
  .how-to-sidebar { display: none; }
  .po-container { padding: 20px; }
}
@media (max-width: 768px) {
  .po-top-row { grid-template-columns: 1fr 1fr; }
  .po-mid-row { grid-template-columns: 1fr; }
  .po-color-grid { grid-template-columns: repeat(3,1fr); }
}
@media (max-width: 480px) {
  .po-top-row { grid-template-columns: 1fr; }
}
</style>
